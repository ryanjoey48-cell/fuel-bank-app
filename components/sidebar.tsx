    ...
    <>
      ...
      >
        ...
        <div className="mb-6 w-full min-w-0 rounded-[1.5rem] border border-brand-100/70 bg-[linear-gradient(145deg,rgba(255,255,255,0.99),rgba(244,239,255,0.78))] px-3.5 py-4 shadow-[0_20px_40px_rgba(38,18,78,0.06)] md:mb-8 md:border-brand-100/70 md:bg-[linear-gradient(145deg,rgba(255,255,255,0.98),rgba(246,242,253,0.9))] md:px-4">
          <div className="flex min-w-0 flex-col items-center justify-center text-center">
            ...
            <div className="mt-4 flex w-full max-w-[220px] min-w-0 flex-col items-center">
              <p className="w-full text-center text-[11px] font-medium uppercase tracking-[0.2em] text-slate-500 sm:text-xs md:text-slate-500">
                {t.common.appSubtitle}
              </p>
              <h1 className="mt-2.5 w-full text-center text-[12px] font-semibold uppercase leading-[1.35] tracking-[0.03em] text-slate-950 sm:text-[12.5px] md:text-slate-950">
                {t.common.appName}
              </h1>
            </div>
          </div>
        ...
        <div className="mb-3 px-1">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500 md:text-slate-500">
            {t.common.navigation}
          </p>
        </div>
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  active
                    ? "border border-brand-100 bg-brand-50 text-brand-800 shadow-[0_16px_30px_rgba(95,51,183,0.08)]"
                    : "border border-transparent text-slate-600 hover:bg-brand-50/70 hover:text-slate-950 hover:shadow-[0_12px_22px_rgba(38,18,78,0.05)]"
                )}
                onClick={onClose}
              >
                <div
                  className={clsx(
                    ...
                    active
                      ...
                      : "border-slate-200/80 bg-white text-slate-500 group-hover:border-brand-100 group-hover:text-brand-700"
                  )}
                >
        ...
        <div className="mt-6 w-full min-w-0 rounded-[1.35rem] border border-brand-100/70 bg-white/96 px-3.5 py-3.5 shadow-[0_14px_28px_rgba(38,18,78,0.05)] md:mt-auto md:border-brand-100/70 md:bg-white/90 md:px-4">
          ...
          <p className="mt-2 break-words text-sm leading-6 text-slate-600 md:text-slate-600">
            {t.common.appSubtitle}
          </p>
        </div>
      </aside>
